...
class TestZkSyncBridgeAdapter:
    ...
    def test_get_supported_assets_valid_chain_zksync(self, adapter):
    ...
    def test_estimate_bridge_fee_erc20_token(self, adapter):
    ...
    def test_bridge_assets_l1_to_l2_success(self, adapter, mock_protocol):
    ...
    def test_bridge_assets_l2_to_l1_success(self, adapter, mock_protocol):
    ...
    def test_bridge_assets_erc20_token_success(self, adapter, mock_protocol):
    ...
    def test_fee_estimation_direction_difference(self, adapter):
    ...
    def test_supported_assets_include_native_eth(self, adapter):
    ...
    def test_supported_assets_include_erc20_tokens(self, adapter):
    ...
    def test_bridge_direction_mapping(self, adapter, mock_protocol):
    ...
    def test_decimal_amount_preservation(self, adapter, mock_protocol):
