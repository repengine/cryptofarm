        ...
        try:
            ...
            if hasattr(risk_manager, 'circuit_breaker_active'):
                circuit_breaker_status = (
                    1 if risk_manager.circuit_breaker_active else 0
                )
    ...
    def collect_capital_allocator_metrics(self, allocator: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(allocator, 'portfolio_history') and allocator.portfolio_history:
                ...
                for protocol, allocation in (
                    latest_metrics.protocol_allocations.items()
                ):
    ...
    def collect_all_metrics(
        ...
        try:
            all_metrics = {
                ...
                'system': dataclasses.asdict(self.collect_system_metrics())
            }

            if risk_manager:
                all_metrics['risk_manager'] = (
                    self.collect_risk_manager_metrics(risk_manager)
                )
