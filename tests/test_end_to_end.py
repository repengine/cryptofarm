...
from airdrops.scheduler.bot import AirdropSchedulerBot, TaskStatus
...
def test_daily_operation_cycle(
    ...
    AirdropSchedulerBot(full_system_config)
...
def test_multi_day_portfolio_evolution(full_system_config):
    ...
    for day in range(7):
        ...
        market_conditions = _generate_market_conditions(day)
        ...
        day_return = _simulate_daily_return(portfolio, market_conditions)
